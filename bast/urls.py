...
urlpatterns = [
    ...
    path('all_records/', views.BastAllRecordsView.as_view(), name='bast_all_records'),
    ...
    path('api/bastrecord-list/<int:counts>/', views.bastrecord_list_api, name='bastrecord_list_api'),
    ...
    path('api/export-csv/', views.export_bast_to_csv, name='export_bast_csv'),
]